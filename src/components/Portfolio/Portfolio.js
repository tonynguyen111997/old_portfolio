	...
	return (
		<div id="portfolio-container" className="portfolio">
			...
			<div className="card-container" style={{opacity: portfolioOpac}}>
				...
				<Card id="card2" img={fccImg} alt="free code camp riverside github" 
				...
				<Card id="card3" img={smilurImg} alt="free code camp riverside github" 
					...
					largeDesc="Social media Android app that is currently under development. Currently I am
										...
										and Android Studio."/>
				<Card id="card4" img={simonImg} alt="simon game" 
				...
				<Card id="card5" img={tictactoeImg} alt="tic tac toe" 
				...
				<Card id="card6" img={calculatorImg} alt="calculator app" 
						...
						largeDesc="Calculator app that functions just like a normal calculator. While developing
											 ...
											 calculator. "/>
				<Card id="card7" img={wikiViewerImg} alt="wiki viewer app" 
				...
				<Card id="card8" img={weatherImg} alt="weather forecast app" 
